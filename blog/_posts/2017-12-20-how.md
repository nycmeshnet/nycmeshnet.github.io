...
Some groups never get around to installing anything. Just go and install your first node to prove you can. Set up a public access point in a cafe or other meeting place. Set the SSID to "-Our Name-" (the dash means it will be at the top of the list of SSIDs) With each successful install you get experience, publicity and more members joining.
