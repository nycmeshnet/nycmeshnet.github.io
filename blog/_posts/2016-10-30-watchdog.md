...
I made this every 7 minutes as I think you might get a cascade of restarts if you have every node in a mesh checking every minute. Also this would disrupt mesh only traffic if you weren't using an internet gateway.
