...
4,5,7,8 are used for power over ethernet (POE). Pins 4 & 5 are negative POE and 7 & 8 are positive POE

If you plug POE into the "main" port of a NanoStation, the secondary port will have live POE! This POE passthrough is great if you want to power a second NanoStation, but if you plug a live POE cable into an adapter or some device that does not expect POE it can break. 
